...
$$
\dfrac{\partial (\rho\, x (x-\gamma)(1-\alpha\, x))}{\partial x}  = - \rho\, \gamma + 2 \rho\, x(1 + \alpha \gamma) - 3 \rho\, \alpha\, x^2
$$
...
$$
\dfrac{d V(x(t))}{d t} = 2 \rho\, x(t) \left(x(t) - \dfrac{1}{\alpha}\right) (1 - \alpha\, x(t))= -\rho\,\alpha\, x(t)\left(x(t) - \dfrac{1}{\alpha}\right)^2
$$
...
$$
x - x^\star - x^\star \log  \frac{x}{x^\star} \geq 0
$$
