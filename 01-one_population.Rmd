...
$$
\dfrac{d x(t)}{dt} = \alpha\, x(t) \log\left(\frac{K}{x(t)}\right) 
$$

where $\alpha$ and $K$ are positive parameters. Solve the model for initial condition $x(0) = x_0$.

Simulate the growth when $K = 10$ and $\alpha = 1$, with starting conditions $x(0) = 20$ and $x(0) = 0.1$.
