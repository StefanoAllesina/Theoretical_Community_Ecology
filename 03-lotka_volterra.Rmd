...
$$
J_{ij} = \dfrac{\partial (r_i x_i + \sum_j A_{ij} x_i x_j)}{\partial x_j}  = A_{ij} x_i
$$
...
$$
V( x^\star ) = \sum_i \left(s_i x_i^\star + \left(s_i x_i^\star - x_i^\star \sum_j B_{ij} x_j^\star \right) \right) = \sum_i s_i x_i^\star
$$
