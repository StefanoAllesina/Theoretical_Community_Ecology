...
Note the parallel with MacArthur's Lyapunov function (which was in fact suggested by Kimura, inspired by Fisher's fundamental theorem of natural selection). See @baez2021fundamental for a discussion of Fisher's theorem in the context of the replicator equation.
