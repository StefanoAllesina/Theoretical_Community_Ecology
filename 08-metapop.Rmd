...
Definition of metapopulations, Levins' model, extensions to multispecies, network structure. Equivalence with SIS model.
...
NIMFA model, equivalence with Hanski-Ovaskainen
